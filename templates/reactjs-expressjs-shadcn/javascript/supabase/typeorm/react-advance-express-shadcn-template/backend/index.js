...
AppDataSource.initialize()
  .then(() => {
    console.log('✅ Connected to Supabase/Postgres using TypeORM');
  })
  .catch((err) => {
    console.error('❌ Supabase/Postgres connection error:', err);
    console.log('⚠️ Please check your Supabase/Postgres URI and ensure the database server is running.');
  });

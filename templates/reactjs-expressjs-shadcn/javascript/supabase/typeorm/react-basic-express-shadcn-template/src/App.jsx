  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-50">
      ...
      <p className="text-lg text-center text-gray-700 mb-2">
        This template uses <span className="font-semibold">Postgres (Supabase)</span> as the database and <span className="font-semibold">TypeORM</span> as the ORM for backend integration.
      </p>
      <div className="bg-white rounded-lg shadow p-4 mt-4 max-w-xl mx-auto">
        <ul className="list-disc pl-6 text-left text-gray-800">
          <li>Frontend: ReactJS (Vite, Shadcn UI, Tailwind CSS)</li>
          <li>Backend: Express.js (JavaScript)</li>
          <li>Database: Postgres (Supabase)</li>
          <li>ORM: TypeORM</li>
        </ul>
        <p className="mt-4 text-sm text-gray-500">
          <strong>Important:</strong> Make sure your backend server is running and Supabase/Postgres is connected.<br/>

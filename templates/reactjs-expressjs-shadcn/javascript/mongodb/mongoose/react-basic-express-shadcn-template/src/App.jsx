  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-50">
      ...
      <p className="text-lg text-center text-gray-700 mb-2">
        This template uses <span className="font-semibold">MongoDB</span> as the database and <span className="font-semibold">Mongoose</span> as the ORM for backend integration.
      </p>

...
# Get this from your Supabase project dashboard`}
        ...
        <div style={{ marginBottom: '1rem' }}>
          ...
          <ul style={{ margin: '0', paddingLeft: '1.5rem' }}>
            <li><code style={{ background: '#e9ecef', padding: '0.2rem 0.4rem', borderRadius: '4px' }}>drizzle-orm: ^0.44.4</code></li>
...
npx drizzle-kit push`}
      ...
      <div style={{ 
        ...
        <ul style={{ margin: '0', paddingLeft: '1.5rem' }}>
          ...
          <li>Update your Drizzle schema in <code style={{ background: '#e9ecef', padding: '0.2rem 0.4rem', borderRadius: '4px' }}>lib/schema.ts</code></li>

    ...
    <main style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '900px', margin: '0 auto' }}>
      <div style={{ 
        ...
        <p style={{ fontSize: '1.1rem', margin: '0', opacity: '0.9' }}>
          Modern full-stack application with Next.js, NeonDB PostgreSQL, and Drizzle ORM
        </p>
      </div>
      ...
      <div style={{ 
        ...
        <ol style={{ margin: '0', paddingLeft: '1.5rem' }}>
          ...
          <li>Run <code>npm run db:generate</code> to generate database migrations</li>
          <li>Run <code>npm run db:migrate</code> to apply migrations</li>

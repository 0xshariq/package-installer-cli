    ...
    <main style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <div style={{ 
        ...
        <p style={{ fontSize: '1.1rem', margin: '0', opacity: '0.9' }}>
          Your project has been successfully scaffolded with Supabase integration using Prisma ORM.
        </p>
      </div>
...
# Get this from your Supabase project dashboard`}
        ...
        <div style={{ marginBottom: '1rem' }}>
          ...
          <ul style={{ margin: '0', paddingLeft: '1.5rem' }}>
            <li><code style={{ background: '#e9ecef', padding: '0.2rem 0.4rem', borderRadius: '4px' }}>@prisma/client: ^5.10.0</code></li>
            <li><code style={{ background: '#e9ecef', padding: '0.2rem 0.4rem', borderRadius: '4px' }}>prisma: ^5.10.0</code> (dev dependency)</li>
          </ul>
        </div>

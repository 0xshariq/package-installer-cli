      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl p-8 mb-8 shadow-lg">
          ...
          <p className="text-xl opacity-90">
            Your project has been successfully scaffolded with Supabase integration using Prisma ORM and Tailwind CSS.
          </p>
        </div>
...
# Get this from your Supabase project dashboard`}
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-600">
              <li><code className="bg-gray-100 px-2 py-1 rounded text-sm font-mono">@prisma/client: ^6.13.0</code></li>
              <li><code className="bg-gray-100 px-2 py-1 rounded text-sm font-mono">prisma: ^6.13.0</code> (dev dependency)</li>
            </ul>
          </div>
...
npx prisma db push`}
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-blue-700">
            ...
            <li>Update your Prisma schema in <code className="bg-blue-100 px-2 py-1 rounded text-sm font-mono">prisma/schema.prisma</code></li>

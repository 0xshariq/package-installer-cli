    ...
    <main style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <div style={{ 
        ...
        <p style={{ fontSize: '1.1rem', margin: '0', opacity: '0.9' }}>
          Your project has been successfully scaffolded with MongoDB integration using Typegoose.
        </p>
      </div>
...
# Or: mongodb+srv://username:password@cluster.mongodb.net/database`}
        ...
        <div style={{ marginBottom: '1rem' }}>
          ...
          <ul style={{ margin: '0', paddingLeft: '1.5rem' }}>
            ...
            <li><code style={{ background: '#e9ecef', padding: '0.2rem 0.4rem', borderRadius: '4px' }}>@typegoose/typegoose: 12.17.0</code></li>
          </ul>
        </div>
      </div>
      ...
      <div style={{ 
        ...
        <ul style={{ margin: '0', paddingLeft: '1.5rem' }}>
          ...
          <li>Create your first model using Typegoose decorators in <code style={{ background: '#e9ecef', padding: '0.2rem 0.4rem', borderRadius: '4px' }}>lib/models/</code></li>

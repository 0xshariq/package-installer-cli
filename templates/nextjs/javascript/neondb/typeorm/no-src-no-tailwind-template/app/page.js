    ...
    <main style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <div style={{ 
        ...
        <p style={{ fontSize: '1.1rem', margin: '0', opacity: '0.9' }}>
          Your project has been successfully scaffolded with NeonDB integration using TypeORM.
        </p>
      </div>
...
# Get these values from your NeonDB project dashboard`}
          </pre>
        </div>
      ...
      <div style={{ 
        ...
        <ul style={{ margin: '0', paddingLeft: '1.5rem' }}>
          <li>Set up your NeonDB project and get the database credentials</li>
